...
class TDataGridAction extends TAction
{
    ...
    /**
     * metodo getFk()
     * retorna o nome do campo de dados relativo a FK do relacionamento
     * definido pelo metodo setFk()
     */
     ...
     * que sera passado juntamente com a acao definindo a Did do relacionamento
