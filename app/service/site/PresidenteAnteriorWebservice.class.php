 ...
 */
class PresidenteAnteriorWebservice
{
	...
	static public function getDados()
	{
		...
		{ 
			...
			$criteria->add( new TFilter( 'situacao', '=', 'INATIVO' ) );
            $criteria->add( new TFilter( 'tipodiretor_id', '=', '1' ) );
...
PresidenteAnteriorWebservice::getDados();
