...
class TipoDiretorList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle(('Listagem de Tipo Diretor'));
        ...
        $this->form->addAction(_t('New'),  new TAction(array('TipoDiretorForm', 'onEdit')), 'bs:plus-sign green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('TipoDiretorForm', 'onEdit'));
    ...
    function onReload($param = NULL)
    {
        ...
        $repository = new TRepository('TipoDiretorRecord');
        $limit = 10;
    ...
    function Delete($param)
    {
        ...
        $cadastro = new TipoDiretorRecord($key);
