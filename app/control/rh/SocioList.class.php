...
class SocioList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_Socio');
        $this->form->setFormTitle(('Listagem de Socio'));
        ...
        $this->form->addAction(_t('New'),  new TAction(array('SocioForm', 'onEdit')), 'bs:plus-sign green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('SocioForm', 'onEdit'));
        ...
        $action3 = new TDataGridAction(array('DependenteDetalhe', 'onReload'));
        $action3->setLabel('Dependente');
        $action3->setImage('fa:sitemap green fa-lg');
        $action3->setField('id');
        $action3->setFk('id');
        
        $action4 = new TDataGridAction(array('SocioPlanoSaudeDetalhe', 'onReload'));
        $action4->setLabel('Plano Saude');
        $action4->setImage('fa:heartbeat red fa-lg');
        $action4->setField('id');
        $action4->setFk('id');
