...
class ModuloList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle(('Listagem de Modulo'));
        ...
        $this->form->addAction(_t('New'),  new TAction(array('ModuloForm', 'onEdit')), 'bs:plus-sign green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('ModuloForm', 'onEdit'));
