...
class GrupoMenuList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_grupomenu');
        $this->form->setFormTitle(('Listagem de Grupo Menu'));
        ...
        $this->form->addAction(_t('New'),  new TAction(array('GrupoMenuForm', 'onEdit')), 'bs:plus-sign green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('GrupoMenuForm', 'onEdit'));
    ...
    function Delete($param)
    {
        ...
        $cadastro = new GrupoMenuRecord($key);
