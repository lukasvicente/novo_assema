...
/*
 * classe UsuarioSocioList
 * Cadastro de UsuarioSocio: Contem a listagem e o formulario de busca
 */
...
class UsuarioSocioList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_UsuarioSocio');
        $this->form->setFormTitle(('Listagem de Usuario Socio'));
        ...
        $this->form->addAction(_t('New'),  new TAction(array('UsuarioSocioForm', 'onEdit')), 'bs:plus-sign green');
        ...
        $column_login = new TDataGridColumn('login', ('Login'), 'left',450);
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('UsuarioSocioForm', 'onEdit'));
        $action_edit->setButtonClass('btn btn-default');
        $action_edit->setLabel(_t('Edit'));
        $action_edit->setImage('fa:pencil-square-o blue fa-lg');
        $action_edit->setField('usuario_id');
