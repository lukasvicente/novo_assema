...
class GrupoMenuForm extends TPage 
{
    ...
    public function __construct() {
        ...
        $this->form = new BootstrapFormBuilder('form_grupomenu');
        $this->form->setFormTitle('Formulário de Grupo Menu');
        ...
        $nome->forceUpperCase();
        $nome->setProperty('placeholder', 'Ex.: CADASTRO');
        ...
        $this->form->addAction('Voltar',  new TAction(array('GrupoMenuList', 'onReload')), 'back_blue_arrow.png');
    ...
    function onSave() 
    {
        ...
        $cadastro = $this->form->getData( 'GrupoMenuRecord' );
        ...
        try 
        {
            ...
            }else 
            {
                ...
                TApplication::gotoPage( 'GrupoMenuList', 'onReload' ); // reload
    ...
    function onEdit( $param ) 
    {
        ...
        try 
        {
            ...
            if( isset( $param['key'] ) ) 
            {
                ...
                $object = new GrupoMenuRecord( $key );  // instantiates object City
