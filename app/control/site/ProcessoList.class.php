...
class ProcessoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_Processo');
        ...
        $this->form->addAction(_t('New'),  new TAction(array('ProcessoForm', 'onEdit')), 'bs:plus-sign green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('ProcessoForm', 'onEdit'));
    ...
    function Delete($param)
    {
        ...
        $cadastro = new ProcessoRecord($key);
