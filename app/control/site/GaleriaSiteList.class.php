...
class GaleriaSiteList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_galeriaSite');
        $this->form->setFormTitle(('Listagem da Galeria'));
        ...
        $this->form->addAction(_t('New'),  new TAction(array('GaleriaSiteForm', 'onEdit')), 'bs:plus-sign green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('GaleriaSiteForm', 'onEdit'));
        ...
        $action3 = new TDataGridAction(array('GaleriaImagemDetalhe', 'onReload'));
        $action3->setLabel('Imagem');
...

    {
        ...
        $cadastro = new GaleriaSiteRecord($key);
    ...
    function Delete($param)
    {
        ...
        try{
            ...
            unlink("app/images/site/galeria/".$cadastro->arquivo);
