...
class ArquivoSiteList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_ArquivoSite');
        $this->form->setFormTitle(('Listagem de Arquivo'));
        ...
        $this->form->addAction(_t('New'),  new TAction(array('ArquivoSiteForm', 'onEdit')), 'bs:plus-sign green');
        ...
        $column_name = new TDataGridColumn('nome', ('Documento'), 'left');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('ArquivoSiteForm', 'onEdit'));
    ...
    function onReload($param = NULL)
    {
        ...
        $repository = new TRepository('ArquivoSiteRecord');
        $limit = 10;
    ...
    function Delete($param)
    {
        ...
        $cadastro = new ArquivoSiteRecord($key);

        try{

            unlink("app/documents/site/arquivo/".$cadastro->arquivo);
            $cadastro->delete();
